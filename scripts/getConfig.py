...
def getConfig(dir):
    ...
    IMGPROCESS["SRCZOOM"] = int(IMGPROCESS["SRCZOOM"]) if "SRCZOOM" in IMGPROCESS else SRCZOOM
    ...
    IMGPROCESS["PERZOOM"] = int(IMGPROCESS["PERZOOM"]) if "PERZOOM" in IMGPROCESS else PERZOOM
